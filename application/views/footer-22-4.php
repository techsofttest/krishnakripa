        ...
        <div class="col-md-6 col-lg-4 col-xl-4">
          <div class="widget footer-widget footer-left-side">
            ...
            <div class="as-widget-contact">
			  ...
			  <h3>Krishnakripa Residency</h3>
			   <div class="info-box">
                <div class="info-box_icon"> <i class="fa-solid fa-location-dot"></i> </div>
                <p class="info-box_text">Building No. XV/421, XV/422,<br> Ambalamugal P.O,Kuzhikkadau-682303,Kochi,Kerala</p>
              </div>
...
<div class="slide-slide-bar "> <a href="javascript:void(0);" title="" class="slide-menu-icon floating-one aubu" id="opener"> Enquire Now</a>
  <div id="slide-panel">
    <div class="overflow">
      ...
      <form method="post" action="<?php echo base_url()?>Home/Enquiry">
        <div class="formWrap">
          <div class="fieldset">
