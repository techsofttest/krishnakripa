          ...
          <div class="row">
			...
			<div class="box">
              ...
              <div class="col-xs-12 col-sm-9 row-seperate field_wrapper">
	    		    <input  class="form-control" name="ao_name" value="<?= $ao['ao_name']; ?>" type="text" required>
				      </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-9 row-seperate field_wrapper">
	    		    <input  class="form-control" name="ao_price" value="<?= $ao['ao_price']; ?>"  type="number" required>
				      </div>
              </div>
