...
<?php $this->load->view('admin/includes/header');?>
      ...
      <div class="content-wrapper">
	    ...
	    <input class="form-control" name="title"  type="text" value="<?php echo $Attractions['att_title']; ?>" required>	
							</div>
                          </div>
                    ...
                    <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
							  ...
							  <textarea class="form-control" name="desc"  id="editor1" rows="5" cols="40" type="text"><?php  echo $Attractions['att_desc']; ?></textarea>	
							</div>
                          </div>    
                           ...
                           <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
							  <textarea class="form-control" name="meta_title"required><?php echo $Attractions['meta_title'];  ?></textarea>	
							</div>
                          </div>
                           ...
                           <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
							  <textarea class="form-control" name="meta_key"  required><?php echo $Attractions['meta_keyword']; ?></textarea>	
							</div>
                          </div>
                           ...
                           <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-9 row-seperate">
							  <textarea class="form-control" name="meta_desc"  required><?php echo $Attractions['meta_description']; ?></textarea>	
							</div>
                          </div>
                             ...
                             <div class="row">
						     <div class="col-xs-12 col-sm-3 row-seperate">
							 <label>Image (425X300px)<strong style="color:#F00;"></strong></label>
                             
                             </div>
                  <div class="col-xs-12 col-sm-9 row-seperate">
	    			
                   <img class="editimg" src="<?php echo base_url();?>uploads/Attractions/<?php echo $Attractions['att_image'];?>"  />
