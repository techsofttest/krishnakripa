...
class Home extends MY_Controller {
  ...
  $exstay = array('hotel'=>1);
  $data['exstay_data']	=	$this->Admin_model->fetch_data_cond('room',$exstay,'roomid','desc');
  $data['feat']	=	$this->Admin_model->fetch_limit('content','4','6','contentId','Desc');
  $data['gal1']	=	$this->Admin_model->fetch_limit('gallery','1','0','gallery_id','Desc');
  $data['gal2']	=	$this->Admin_model->fetch_limit('gallery','3','1','gallery_id','Desc');
  $data['gal3']	=	$this->Admin_model->fetch_limit('gallery','2','4','gallery_id','Desc');
  $data['video']	=	$this->Admin_model->fetch_limit('video','3','0','vi_id','Desc');
