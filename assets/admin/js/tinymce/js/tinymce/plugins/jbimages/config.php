...
-------------------------------------------------------------------*/
	...
	$config['editor_path'] =$config['base_url'];
...
-------------------------------------------------------------------*/
/*
	$path_new = explode('/assets',$config['editor_path']);
	$config['upload_path'] = $path_new[0] . $config['img_path'];
	$config['img_path'] = '/arabianhomes/uploads/images';
